...
| Fork 远程 | https://github.com/liketocood345/EasyVtuberStudio |
...
Git 远程：`origin` = fork，`upstream` = 官方。详见 [docs/FORK_ROOT.md](docs/FORK_ROOT.md)。
...
| 提交 | 说明 |
|------|------|
| （待 push） | **便携 DEPLOY 四档**（basic / face / THA3 / THA4）；重复安装与 venv 复制修复；面捕模式 `MOCAP_INPUT_MODE_MEDIAPIPE` 修复；Mouse + Audio 面捕；文档整理见 [docs/PREP_PUSH.md](docs/PREP_PUSH.md) |
